...
public class UploadFiles {
    ...
    * */
    public static String upload(String baseDir, MultipartFile part) throws IOException {
        ...
        // File : 파일, 디렉토리를 생성, 수정, 삭제. 이름변경등에 사용할 수 있는 객체
        // 실제 파일이없더라도 생성 가능
        ...
        // 고유 이름으로 변경
        String fileName = part.getOriginalFilename(); //원본파일명

        String uniqFileName = UploadFileName.getUniqueName(fileName); //고유파일명
