...
public class ExampleController2 {
    ...
    * - 이름이 일치하는 용청 파라미터를 개별 변수에 바인딩
    * - 기본적으로 해당 파라미터가 없으면 예외가 발생
    * */

    @GetMapping("/example02")
    public  String example02(@RequestParam(name = "id", defaultValue = "defaultUser") String id, @RequestParam(name = "password", required = true) String password, Model model){
    ...
    * - URL의 중괄호로 표시한 경로변수값을 메서드의 매개변수에 반인딩
    * */
