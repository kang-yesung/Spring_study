...
public class JsonController {
    ...
    * */
    ...
    /*
    * @RequestBody
    * - 클라이언트가 보낸 json 형식의 대이터를 자바 객체로 자동 변환(역직렬화)
    * - 주로 JSON 데이터가 Body에 포함된 경우 사용(POST, PUT)
    *
    * @RequestEntity
    * - 응답 본문, 상태코드 해더를 직접 제어할 수 있는 응답 방식
    * */

    @PostMapping("/ex02")
    public ResponseEntity<String> example02(@RequestBody LoginRequestDTO dto){
    ...
    /*
    * ResponseEntity
    * - 본문, 헤더, 상태코드 -> 모두 직접 지정하고 싶을떄
    * */
    @GetMapping("/ex03")
    public ResponseEntity<String> example03(){
        //바디
        String body = "BODYBODYBODYBODYBODYBODYBODYBODYBODYBODY";
